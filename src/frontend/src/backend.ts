...
export class Backend implements backendInterface {
    ...
    async addTrade(arg0: number, arg1: string, arg2: string, arg3: string): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.addTrade(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getTradesByDateRange(arg0: string, arg1: string): Promise<Array<Trade>> {
        if (this.processError) {
            try {
